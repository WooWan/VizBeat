...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }: Props) => (
  ...
  >
    <Image src={imgUrl} alt={title} className="absolute w-full h-full object-cover rounded-[24px]" fill />
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        <p className="font-bold text-[16px] leading-[20.16px] text-white uppercase">Visualize Instrument</p>
